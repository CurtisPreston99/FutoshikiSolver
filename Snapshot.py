...
class snapshot:
    ...
    def getCellsPoss(self):
        cell1d=[j for sub in self.cells for j in sub]
        cell1d= sorted(cell1d, key=lambda x: x.getPossiblesLen())
        cell1d=[cel for cel in cell1d if cel.val==0]
        return cell1d
